        ...
        case $choice in
            1)
                ...
                case $method_choice in
                    1)
                        cd ~
                        bash <(curl -s https://raw.githubusercontent.com/Hubdarkweb/HostingCreator/main/installers/skyport.sh)
                        ;;
                    2)
                        exit
                        ;;
            ...
            2)
                ...
                case $method_choice in
                    1)
                        ...
                        git clone https://github.com/Hubdarkweb/skyportd.git && cd skyportd
                        npm install
                        eval "$user_command"
                        npm i -g pm2 
            ...
            3)
                ...
                case $method_choice in
                    1)
                        ...
                        bash <(curl -s https://raw.githubusercontent.com/Hubdarkweb/HostingCreator/main/installers/hydren.sh)
                        ;;
                    2)
                        exit
                        ;;
